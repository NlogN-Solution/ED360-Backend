...
class EmployeeProfileRead(BaseModel):
    ...
    # Resolved display name — department_ref.name if department_id is set,
    # else the legacy free-text `department` string for pre-Department rows.
    department_name: str | None = None
    # Same pattern as department_name, using office/office_location.
