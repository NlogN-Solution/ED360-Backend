...
from ..models.enums import ConversionSource, FollowUpMethod, FollowUpOutcome, LeadPriority, LostReason
...
class LeadFollowUpComplete(BaseModel):
    # Optional so the list view's one-field "what happened?" quick-log can complete a
    # follow-up without forcing the user to classify an outcome — the service already
    # tolerates a missing outcome (see LeadService.complete_follow_up).
