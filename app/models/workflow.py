...
from .enums import ApplicationWorkflowStatus, ChecklistItemStatus, DocumentType, WorkflowActivityType, WorkflowStepStatus


class WorkflowTemplate(Base, UUIDPKMixin, TimestampMixin, TenantMixin):
    ...
    __table_args__ = (
        ...
        Index("idx_workflow_templates_organization_id", "organization_id"),
    )
...
class ApplicationWorkflow(Base, UUIDPKMixin, TimestampMixin, TenantMixin):
    ...
    __table_args__ = (
        ...
        Index("idx_application_workflows_organization_id", "organization_id"),
    )
