...
class Department(Base, UUIDPKMixin, TimestampMixin, TenantMixin):
...
class EmployeeEmploymentEvent(Base, UUIDPKMixin, TenantMixin):
    ...
    __table_args__ = (
        ...
        Index("idx_employee_employment_events_organization_id", "organization_id"),
    )
